...
public class OpenChannelActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(OpenChannelActivity.this, MainActivity.class);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    startActivity(i, ActivityOptions.makeSceneTransitionAnimation(OpenChannelActivity.this).toBundle());
                }
            }
        });
    ...
    private void displayFirebaseRegId() {
        ...
        updatePost.postUpdate(OpenChannelActivity.this,imei,token,"","",jam,tanggal);
    }
